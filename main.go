...
func main(){
	fmt.Println("I think that life is surprising.")
	...
	fmt.Println("The total for Tax Calculation is:", 22500*33/100)
	fmt.Println("The total for Funky Math is:", (12+45+67)-(21-5-3))
	fmt.Println("The total for 23 Times of Earth Diameter is:", 40075017*23)
 }
